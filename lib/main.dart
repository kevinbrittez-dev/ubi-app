    ...
    if (_autoEnabled) {
      await Workmanager().registerPeriodicTask(
        ...
        constraints: Constraints(
          ...
          requiresBatteryNotLow: false,  // 🟢 NUEVO: Funciona con batería baja
          requiresCharging: false,       // 🟢 NUEVO: No requiere estar enchufado
          requiresDeviceIdle: false,     // 🟢 NUEVO: Funciona aunque esté en uso
        ),
        existingWorkPolicy: ExistingPeriodicWorkPolicy.replace,
        backoffPolicy: BackoffPolicy.exponential,  // 🟢 NUEVO: Reintentos inteligentes
        initialDelay: const Duration(seconds: 10),  // 🟢 NUEVO: Comienza en 10s
      );
      await mostrarNotif(
        'Horario guardado',
